...
promise.then(
  () => {
    console.dir('app> Load MongoDB Data.....');
    ...
    Item.count({}, function(err, c) {
      if(c === undefined || c == 0) {
        ...
        // console.log(itemsMock) // ['nodejs', 'javascript']
        ...
        // Item.insertMany(itemsMock).then(function(){
        //     console.dir("Data inserted")  // Success
        // }).catch(function(error){
        //     console.error('Error inserting many items: ' + error)      // Failure
        // });
      } else {
